...
- [vercel-labs/quickjs-wasi](https://github.com/vercel-labs/quickjs-wasi) - Snapshotable JavaScript runtime via WebAssembly. Runs QuickJS-NG compiled to WASM with the ability to snapshot the entire VM state — including pending promises — and restore it in a fresh instance.
...
- [nathancmiguel/ALSReplicated](https://github.com/nathancmiguel/ALSReplicated) - This is a community-based effort to fully and effectively replicate Advanced Locomotion System v4 which is permanently free on the Epic Marketplace.
...
- [Jord-JD/php-ssh-connection](https://github.com/Jord-JD/php-ssh-connection) - Provides an elegant syntax to connect to SSH servers and execute commands.
...
- [ubugeeei-prod/vize](https://github.com/ubugeeei-prod/vize) - blazing fast Vue.js toolchain. compiler, linter, type checker, formatter, lsp, story system, editors.  already passed 17k+ tests.
...
- [matthunz/actuate](https://github.com/matthunz/actuate) - A framework for declarative programming in Rust
...
- [twistedfall/opencv-rust](https://github.com/twistedfall/opencv-rust) - OpenCV API bindings for Rust
...
- [wevm/ox](https://github.com/wevm/ox) - Standard Library for the EVM
...
- [johannschopplich/nuxt-prepare](https://github.com/johannschopplich/nuxt-prepare) - 🦎 Run async code at build time, before Nuxt finalizes its config
...
- [sieblyio/binance](https://github.com/sieblyio/binance) - Node.js & JavaScript SDK for Binance REST APIs & WebSockets, with TypeScript & browser support, integration tests, beautification & more.
